...
var SecretManagerMethodHandler = /** @class */ (function () {
    /**
     * @param options A secret manager type or a secret manager method handler.
     */
    function SecretManagerMethodHandler(options) {
     ...
     */
    SecretManagerMethodHandler.prototype.callMethod = function (method) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, callSecretManagerMethodAsync(JSON.stringify(method), this.methodHandler)];
            });
        });
    };
    return SecretManagerMethodHandler;
}());
export { SecretManagerMethodHandler };
